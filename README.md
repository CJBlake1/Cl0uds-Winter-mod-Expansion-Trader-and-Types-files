# Cl0uds Winter mod Expansion Trader and Types files
Expansion trader and types files for the Clouds Winter mod.

This is the Expansion trader files for Cl0uds Winter mod.
Add the json files to the Market folder and add:

		"Clouds_Winter_Backpacks",
		"Clouds_Winter_Clothing",
		"Clouds_Winter_Equipment",
		"Clouds_Winter_Hats_and_Caps",
		"Clouds_Winter_Weapons",
